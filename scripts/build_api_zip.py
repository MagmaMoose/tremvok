...
# The repository root. The package this zips (src/tremvok) and requirements-lambda.txt are
# both repo-level. Counted explicitly so a future move breaks loudly here rather than
# silently zipping nothing — which is exactly what caught the scripts/ move at v2.
